...
function LinkButton({ icon, link, children }) {
    return <a href={link}><button className="bg-sky-700 p-1 w-fit h-fit rounded-xl flex flex-row gap-1 items-center align-middle"><FontAwesomeIcon icon={icon} />{children}<FontAwesomeIcon icon={faArrowRight} /></button></a>;
}
